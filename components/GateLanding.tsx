...
export function GateLanding(){
 ...
 <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[.06] bg-void/75 px-4 py-3 backdrop-blur-xl md:px-8"><div className="mx-auto flex max-w-[1500px] items-center justify-between gap-4"><Link href="/" className="relative z-10 block"><Image src="/vetum-wordmark.jpg" alt="Vetum" width={420} height={150} className="h-10 w-auto object-contain mix-blend-screen md:h-14" priority/></Link><nav className="hidden items-center gap-6 font-mono text-[10px] uppercase tracking-[.18em] text-mist lg:flex"><a href="#loop">Machine</a><a href="#decisions">Decisions</a><Link href="/agents">Agents</Link><Link href="/constitution">Constitution</Link><Link href="/how">How</Link><Link href="/ledger">Ledger</Link></nav><Link href="/app" className="rounded-full border border-white/20 bg-white/[.04] px-4 py-2 font-mono text-[10px] uppercase tracking-[.16em] hover:border-violet hover:bg-violet/10">Enter chamber</Link></div></header>
